...
def get_sales_data():
        ...
        via the terminal, which must be a string of 6 numbers separated by commas. The loop will repeatedly request the data, until it is valid.
        """
        while True:
...
def update_sale_worksheet(data):
        """
        Update sales worksheet, add row with the 
        """
